...
export class CartService {
  ...
  AddProductToCart(id: Number, ratingsQuantity?: number) {
    ...
    this.productsService.getSingleProduct(id).subscribe((prod) => {
      ...
      if (this.cartDataServer.data[0].product === undefined) {
        ...
        this.cartDataServer.data[0].numInCart =
          ratingsQuantity !== undefined ? ratingsQuantity : 1;
        this.CalculateTotal();
        ...
        this.cartDataObs$.next({ ...this.cartDataServer });
        this.toast.success(
          `${prod.product_title} added to the cart.`,
          'Product Added',
          {
            timeOut: 3600,
            progressBar: true,
      ...
      //2. Cart is not empty
        ...
        if (index !== -1) {
          if (ratingsQuantity !== undefined && ratingsQuantity <= prod.ratingsQuantity) {
            this.cartDataServer.data[index].numInCart = this.cartDataServer.data[index].numInCart < prod.ratingsQuantity ? ratingsQuantity : prod.ratingsQuantity;
          } else {
            //this.cartDataServer.data[index].numInCart = this.cartDataServer.data[index].numInCart < prod.ratingsratingsQuantity ? this.cartDataServer.data[index].numInCart++ : prod.ratingsratingsQuantity;
            this.cartDataServer.data[index].numInCart < prod.ratingsQuantity ? this.cartDataServer.data[index].numInCart++ : prod.ratingsQuantity;
          }
          ...
          this.cartDataObs$.next({ ...this.cartDataServer });
          this.toast.info(
            `${prod.product_title} ratingsQuantity updated in the cart.`,
            'Product Updated',
            {
              timeOut: 3600,
              progressBar: true,
        ...
        //2. If the chosen product is not in the cart array
          ...
          this.toast.success(
            `${prod.product_title} ratingsQuantity added in the cart.`,
            'Product Updated',
            {
              timeOut: 3600,
              progressBar: true,
  ...
  UpdateCartData(index: number, increase: Boolean) {
    ...
    if (increase) {
      data.numInCart < data.product.ratingsQuantity ? data.numInCart++ : data.product.ratingsQuantity;
